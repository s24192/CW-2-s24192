...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        var emps = Database.GetEmps();
         ...
         var firstTwo = emps.OrderBy(emp => emp.HireDate).Select(emp => emp).Take(2).ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        var emps = Database.GetEmps();
         ...
         var withMgr = emps.Where(emp => emp.Mgr != null).Select(emp => emp).ToList(); 
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        var emps = Database.GetEmps();
         ...
         var result = from e in emps
                        select new {EName = e.EName, Total = e.Sal + e.Comm ?? 0 }; 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
       ...
       //  var result = from emp in emps
        ...
        //              join grade in grades on emp.Sal equals grade.Losal; 
